    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            <div class="flex items-center gap-2">
                ...
                <span class="text-2xl font-bold text-gray-900">LifeFlow</span>
            </div>
            <div class="hidden md:flex items-center gap-8">
                <a href="#about" class="text-gray-700 hover:text-primary transition">Donor</a>
                <a href="#how-it-works" class="text-gray-700 hover:text-primary transition">Recipient</a>
